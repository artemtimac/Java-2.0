...
import com.aplana.application.modules.Collections;
...
public class Program {
    public static void main(String[] args) {
        ...
        do {
            System.out.println("Enter number of task: (1 - calculator, 2 - string array, 3 - gifts, 4 - collections) [0 - exit]");
